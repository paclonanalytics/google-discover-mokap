    ...
    <DashboardLayout>
      <div className="p-6 space-y-6">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-3xl font-bold">Entity: {entityName}</h1>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Detailed statistics and analytics for entity "{entityName}" will be available after backend integration.
                </p>
              </div>
            </div>
          </CardContent>
